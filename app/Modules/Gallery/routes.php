...
Route::group(['middleware' => ['web', 'auth'], 'namespace' => 'App\Modules\Gallery\Controllers'], function() {
    ...
    Route::post('gallery/photo/associate', ['uses' => 'GalleryController@asssociatePhoto', 'as' => 'postAssociteGallery' ]);
    Route::get('gallery/photo/deassociate/{associative_id}/{photo_id}', ['uses' => 'GalleryController@deAsssociatePhoto', 'as' => 'deAssociatePhoto' ]);
});
