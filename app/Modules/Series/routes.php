...
Route::group(['middleware' => ['web', 'auth'], 'namespace' => 'App\Modules\Series\Controllers'], function() {
   ...
   Route::get('get/point_table/{sllug}',['as' => 'pointTable', 'uses' => 'PointTableController@index']);
   Route::post('get/point_table/{sllug}',['as' => 'pointTable', 'uses' => 'PointTableController@addPoints']);
});
